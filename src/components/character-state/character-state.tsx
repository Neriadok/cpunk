import { Box, Button, FormControl, Grid, IconButton, InputAdornment, Slider, Stack, TextField, Typography } from '@mui/material';
...
import { faBitcoinSign, faBoltLightning, faCircleMinus, faCirclePlus, faDroplet, faHeart, faRedo, faSave, faShield, faSkullCrossbones } from '@fortawesome/free-solid-svg-icons';
        ...
        <Stack spacing={2}>
            ...
            <Stack>
                <Stack spacing={1} direction='row' sx={{ display: 'flex', alignItems: 'center' }}>
                    <IconButton color={(shock + bleed + poison) >= character.stats.TCO ? 'warning' : 'primary'}><FontAwesomeIcon icon={faBoltLightning} /></IconButton>
                    <Box sx={{ flex: 1, pr: 1 }}>
                        <Slider
                            ...
                            onChange={(e: any) => { setShock(e.target?.value || 0); setChanges(true); }} />
                    </Box>
                </Stack>
                <Stack spacing={1} direction='row' sx={{ display: 'flex', alignItems: 'center' }}>
                    <IconButton color={(shock + bleed + poison) >= character.stats.TCO ? 'warning' : 'primary'}><FontAwesomeIcon icon={faSkullCrossbones} /></IconButton>
                    <Box sx={{ flex: 1, pr: 1 }}>
                        <Slider
                            valueLabelDisplay="auto"
                            color='primary'
                            ...
                            min={0}
                            max={character.stats.TCO}
                            onChange={(e: any) => { setPoison(e.target?.value || 0); setChanges(true) }} />
                    </Box>
                </Stack>
                <Stack spacing={1} direction='row' sx={{ display: 'flex', alignItems: 'center' }}>
                    <IconButton color={(shock + bleed + poison) >= character.stats.TCO ? 'warning' : 'primary'}><FontAwesomeIcon icon={faDroplet} /></IconButton>
                    <Box sx={{ flex: 1, pr: 1 }}>
                        <Slider
                            valueLabelDisplay="auto"
                            color='primary'
                            ...
                            min={0}
                            max={character.stats.TCO}
                            onChange={(e: any) => { setBleed(e.target?.value || 0); setChanges(true); }} />
                    </Box>
                </Stack>
            </Stack>
