...
function handleApiRequestError(response: Response) {
  ...
  const messages: { [code: string]: string } = {
    ...
    status403:
      'Forbidden. If you think this is an error, please ask your administrator',
    status404:
      'Entity Not Found. Please ensure provided data correspond to a valid entity.',
